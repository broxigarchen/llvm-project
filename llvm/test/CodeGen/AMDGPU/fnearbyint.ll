...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX11,GFX11-TRUE16,GFX11PLUS,GFX11PLUS-TRUE16 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX11,GFX11-FAKE16,GFX11PLUS,GFX11PLUS-FAKE16 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1200 -mattr=+real-true16 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX11PLUS,GFX11PLUS-TRUE16,GFX12,GFX12-TRUE16 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1200 -mattr=-real-true16 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX11PLUS,GFX11PLUS-FAKE16,GFX12,GFX12-FAKE16 %s
...
; SICI:       ; %bb.0: ; %entry
; SICI-NEXT:    s_load_dword s6, s[4:5], 0xb
; SICI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; SICI-NEXT:    s_mov_b32 s3, 0xf000
; SICI-NEXT:    s_mov_b32 s2, -1
; SICI-NEXT:    s_waitcnt lgkmcnt(0)
; SICI-NEXT:    v_rndne_f32_e32 v0, s6
...
; SICI:       ; %bb.0: ; %entry
; SICI-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0xd
; SICI-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x9
; SICI-NEXT:    s_mov_b32 s7, 0xf000
; SICI-NEXT:    s_mov_b32 s6, -1
; SICI-NEXT:    s_waitcnt lgkmcnt(0)
; SICI-NEXT:    v_rndne_f32_e32 v3, s3
; SICI-NEXT:    v_rndne_f32_e32 v2, s2
; SICI-NEXT:    v_rndne_f32_e32 v1, s1
; SICI-NEXT:    v_rndne_f32_e32 v0, s0
; SICI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[4:7], 0
; SICI-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_rndne_f32_e32 v3, s3
; GFX11-NEXT:    v_rndne_f32_e32 v2, s2
; GFX11-NEXT:    v_rndne_f32_e32 v1, s1
...
; CI-NEXT:    s_waitcnt lgkmcnt(0)
; CI-NEXT:    v_rndne_f64_e32 v[2:3], s[2:3]
; CI-NEXT:    v_rndne_f64_e32 v[0:1], s[0:1]
; CI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; CI-NEXT:    s_mov_b32 s3, 0xf000
; CI-NEXT:    s_mov_b32 s2, -1
; CI-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-NEXT:    v_mov_b32_e32 v4, 0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_rndne_f64_e32 v[2:3], s[2:3]
; GFX11-NEXT:    v_rndne_f64_e32 v[0:1], s[0:1]
; GFX11-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
...
; CI-NEXT:    s_mov_b32 s2, -1
; CI-NEXT:    s_waitcnt lgkmcnt(0)
; CI-NEXT:    v_rndne_f64_e32 v[6:7], s[14:15]
; CI-NEXT:    v_rndne_f64_e32 v[4:5], s[12:13]
; CI-NEXT:    v_rndne_f64_e32 v[2:3], s[10:11]
; CI-NEXT:    v_rndne_f64_e32 v[0:1], s[8:9]
...
; VI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_rndne_f64_e32 v[6:7], s[14:15]
; VI-NEXT:    v_rndne_f64_e32 v[4:5], s[12:13]
; VI-NEXT:    v_rndne_f64_e32 v[2:3], s[10:11]
; VI-NEXT:    v_rndne_f64_e32 v[0:1], s[8:9]
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_rndne_f64_e32 v[6:7], s[14:15]
; GFX11-NEXT:    v_rndne_f64_e32 v[4:5], s[12:13]
; GFX11-NEXT:    v_rndne_f64_e32 v[2:3], s[10:11]
; GFX11-NEXT:    v_rndne_f64_e32 v[0:1], s[8:9]
; GFX11-NEXT:    s_clause 0x1
