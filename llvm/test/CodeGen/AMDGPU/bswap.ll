...
; RUN: llc < %s -mtriple=amdgcn-- -mcpu=gfx600 | FileCheck %s --check-prefix=SI
...
; SI-NEXT:    v_alignbit_b32 v3, s2, s2, 24
; SI-NEXT:    v_bfi_b32 v1, s8, v1, v0
; SI-NEXT:    v_bfi_b32 v0, s8, v3, v2
...
; SI-NEXT:    s_mov_b32 s5, s1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    v_alignbit_b32 v0, s11, s11, 8
; SI-NEXT:    v_alignbit_b32 v1, s11, s11, 24
; SI-NEXT:    v_alignbit_b32 v2, s10, s10, 8
; SI-NEXT:    v_alignbit_b32 v4, s10, s10, 24
; SI-NEXT:    v_bfi_b32 v3, s2, v1, v0
; SI-NEXT:    v_alignbit_b32 v0, s9, s9, 8
; SI-NEXT:    v_alignbit_b32 v1, s9, s9, 24
; SI-NEXT:    v_bfi_b32 v2, s2, v4, v2
; SI-NEXT:    v_bfi_b32 v1, s2, v1, v0
; SI-NEXT:    v_alignbit_b32 v0, s8, s8, 8
; SI-NEXT:    v_alignbit_b32 v4, s8, s8, 24
; SI-NEXT:    v_bfi_b32 v0, s2, v4, v0
...
; SI-NEXT:    s_mov_b32 s14, 0xff00ff
...
; SI-NEXT:    v_bfi_b32 v3, s14, v1, v0
; SI-NEXT:    v_alignbit_b32 v0, s5, s5, 8
; SI-NEXT:    v_alignbit_b32 v1, s5, s5, 24
; SI-NEXT:    v_bfi_b32 v2, s14, v4, v2
; SI-NEXT:    v_bfi_b32 v1, s14, v1, v0
; SI-NEXT:    v_alignbit_b32 v0, s4, s4, 8
; SI-NEXT:    v_alignbit_b32 v4, s4, s4, 24
; SI-NEXT:    v_bfi_b32 v0, s14, v4, v0
; SI-NEXT:    v_alignbit_b32 v4, s11, s11, 8
; SI-NEXT:    v_alignbit_b32 v5, s11, s11, 24
; SI-NEXT:    v_bfi_b32 v7, s14, v5, v4
; SI-NEXT:    v_alignbit_b32 v4, s10, s10, 8
; SI-NEXT:    v_alignbit_b32 v5, s10, s10, 24
; SI-NEXT:    v_bfi_b32 v6, s14, v5, v4
; SI-NEXT:    v_alignbit_b32 v4, s9, s9, 8
; SI-NEXT:    v_alignbit_b32 v5, s9, s9, 24
; SI-NEXT:    v_bfi_b32 v5, s14, v5, v4
; SI-NEXT:    v_alignbit_b32 v4, s8, s8, 8
; SI-NEXT:    v_alignbit_b32 v8, s8, s8, 24
; SI-NEXT:    v_bfi_b32 v4, s14, v8, v4
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_perm_b32 v7, 0, s7, 0x10203
; GFX11-NEXT:    v_perm_b32 v6, 0, s6, 0x10203
; GFX11-NEXT:    v_perm_b32 v5, 0, s5, 0x10203
; GFX11-NEXT:    v_perm_b32 v4, 0, s4, 0x10203
...
; SI-NEXT:    s_mov_b32 s5, s1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    v_alignbit_b32 v0, s10, s10, 8
; SI-NEXT:    v_alignbit_b32 v1, s10, s10, 24
; SI-NEXT:    v_alignbit_b32 v2, s11, s11, 8
; SI-NEXT:    v_alignbit_b32 v4, s11, s11, 24
; SI-NEXT:    v_bfi_b32 v3, s2, v1, v0
; SI-NEXT:    v_alignbit_b32 v0, s8, s8, 8
; SI-NEXT:    v_alignbit_b32 v1, s8, s8, 24
; SI-NEXT:    v_bfi_b32 v2, s2, v4, v2
; SI-NEXT:    v_bfi_b32 v1, s2, v1, v0
; SI-NEXT:    v_alignbit_b32 v0, s9, s9, 8
; SI-NEXT:    v_alignbit_b32 v4, s9, s9, 24
; SI-NEXT:    v_bfi_b32 v0, s2, v4, v0
; SI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[4:7], 0
; SI-NEXT:    s_endpgm
;
...
; SI-NEXT:    v_bfi_b32 v1, s14, v1, v0
; SI-NEXT:    v_alignbit_b32 v0, s5, s5, 8
; SI-NEXT:    v_alignbit_b32 v4, s5, s5, 24
; SI-NEXT:    v_bfi_b32 v0, s14, v4, v0
; SI-NEXT:    v_alignbit_b32 v4, s10, s10, 8
; SI-NEXT:    v_alignbit_b32 v5, s10, s10, 24
; SI-NEXT:    v_bfi_b32 v7, s14, v5, v4
...
; SI-NEXT:    v_bfi_b32 v6, s14, v5, v4
; SI-NEXT:    v_alignbit_b32 v4, s8, s8, 8
; SI-NEXT:    v_alignbit_b32 v5, s8, s8, 24
; SI-NEXT:    v_bfi_b32 v5, s14, v5, v4
; SI-NEXT:    v_alignbit_b32 v4, s9, s9, 8
; SI-NEXT:    v_alignbit_b32 v8, s9, s9, 24
; SI-NEXT:    v_bfi_b32 v4, s14, v8, v4
; SI-NEXT:    buffer_store_dwordx4 v[4:7], off, s[0:3], 0 offset:16
; SI-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0
; SI-NEXT:    s_endpgm
...
; SI-NEXT:    v_alignbit_b32 v0, v1, v1, 8
; SI-NEXT:    v_alignbit_b32 v1, v1, v1, 24
; SI-NEXT:    v_bfi_b32 v0, s4, v1, v0
