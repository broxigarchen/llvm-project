...
; GFX7-NEXT:    v_cmp_ngt_f32_e32 vcc, v3, v2
...
; GFX7-NEXT:    v_cvt_f32_f16_e32 v2, v1
; GFX7-NEXT:    v_cvt_f32_f16_e32 v3, v0
; GFX7-NEXT:    v_cmp_nlt_f32_e32 vcc, v3, v2
; GFX7-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc
; GFX7-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    v_cmp_ngt_f32_e32 vcc, v5, v4
; GFX7-NEXT:    v_cndmask_b32_e32 v2, v3, v2, vcc
; GFX7-NEXT:    v_cmp_ngt_f32_e32 vcc, v7, v6
; GFX7-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc
...
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-TRUE16-NEXT:    v_cndmask_b16 v0.h, v2.l, v3.l, vcc_lo
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    v_cvt_f32_f16_e32 v6, v1
; GFX7-NEXT:    v_cvt_f32_f16_e32 v7, v0
; GFX7-NEXT:    v_cmp_nlt_f32_e32 vcc, v5, v4
; GFX7-NEXT:    v_cndmask_b32_e32 v2, v3, v2, vcc
; GFX7-NEXT:    v_cmp_nlt_f32_e32 vcc, v7, v6
; GFX7-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc
; GFX7-NEXT:    v_lshlrev_b32_e32 v2, 16, v2
; GFX7-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; GFX7-NEXT:    v_or_b32_e32 v0, v0, v2
...
; GFX7-NEXT:    v_cvt_f32_f16_e32 v15, v1
; GFX7-NEXT:    v_cvt_f32_f16_e32 v12, v2
; GFX7-NEXT:    v_cvt_f32_f16_e32 v13, v0
; GFX7-NEXT:    v_cmp_ngt_f32_e32 vcc, v11, v10
; GFX7-NEXT:    v_cndmask_b32_e32 v4, v5, v4, vcc
; GFX7-NEXT:    v_cmp_ngt_f32_e32 vcc, v9, v8
; GFX7-NEXT:    v_cndmask_b32_e32 v5, v7, v6, vcc
; GFX7-NEXT:    v_cmp_ngt_f32_e32 vcc, v15, v14
; GFX7-NEXT:    v_cndmask_b32_e32 v1, v3, v1, vcc
; GFX7-NEXT:    v_cmp_ngt_f32_e32 vcc, v13, v12
...
; GFX1170-TRUE16:       ; %bb.0:
; GFX1170-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX1170-TRUE16-NEXT:    v_lshrrev_b32_e32 v4, 16, v2
; GFX1170-TRUE16-NEXT:    v_lshrrev_b32_e32 v5, 16, v0
; GFX1170-TRUE16-NEXT:    v_lshrrev_b32_e32 v6, 16, v3
; GFX1170-TRUE16-NEXT:    v_lshrrev_b32_e32 v7, 16, v1
...
; GFX12-TRUE16-NEXT:    v_cmp_ngt_f16_e64 s1, v5.l, v4.l
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4)
; GFX12-TRUE16-NEXT:    v_cmp_ngt_f16_e64 s2, v7.l, v6.l
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_va_vcc(0)
...
; GFX12-TRUE16-NEXT:    v_cndmask_b16 v1.h, v6.l, v7.l, s2
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    v_cvt_f32_f16_e32 v2, v2
; GFX7-NEXT:    v_cvt_f32_f16_e32 v0, v0
; GFX7-NEXT:    v_min_f32_e32 v5, v6, v5
...
; GFX7-NEXT:    v_cvt_f32_f16_e32 v12, v2
; GFX7-NEXT:    v_cvt_f32_f16_e32 v13, v0
; GFX7-NEXT:    v_cmp_nlt_f32_e32 vcc, v11, v10
; GFX7-NEXT:    v_cndmask_b32_e32 v4, v5, v4, vcc
; GFX7-NEXT:    v_cmp_nlt_f32_e32 vcc, v9, v8
; GFX7-NEXT:    v_cndmask_b32_e32 v5, v7, v6, vcc
; GFX7-NEXT:    v_cmp_nlt_f32_e32 vcc, v15, v14
; GFX7-NEXT:    v_cndmask_b32_e32 v1, v3, v1, vcc
; GFX7-NEXT:    v_cmp_nlt_f32_e32 vcc, v13, v12
; GFX7-NEXT:    v_cndmask_b32_e32 v0, v2, v0, vcc
; GFX7-NEXT:    v_lshlrev_b32_e32 v4, 16, v4
; GFX7-NEXT:    v_lshlrev_b32_e32 v5, 16, v5
; GFX7-NEXT:    v_and_b32_e32 v0, 0xffff, v0
...
; GFX12-TRUE16-NEXT:    v_cmp_nlt_f16_e64 s1, v5.l, v4.l
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4)
; GFX12-TRUE16-NEXT:    v_cmp_nlt_f16_e64 s2, v7.l, v6.l
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-TRUE16-NEXT:    v_cndmask_b16 v1.l, v3.l, v1.l, vcc_lo
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12-TRUE16-NEXT:    v_cndmask_b16 v0.l, v2.l, v0.l, s0
