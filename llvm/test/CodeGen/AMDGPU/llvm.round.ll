...
; RUN: llc -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 -mattr=-flat-for-global < %s | FileCheck --check-prefixes=GFX11,GFX11-TRUE16,GFX11PLUS,GFX11PLUS-TRUE16 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 -mattr=-flat-for-global < %s | FileCheck --check-prefixes=GFX11,GFX11-FAKE16,GFX11PLUS,GFX11PLUS-FAKE16 %s
; RUN: llc -mtriple=r600 -mcpu=redwood < %s | FileCheck --check-prefixes=R600 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1200 -mattr=+real-true16 -mattr=-flat-for-global < %s | FileCheck --check-prefixes=GFX11PLUS,GFX11PLUS-TRUE16,GFX12,GFX12-TRUE16 %s
; RUN: llc -mtriple=amdgcn -mcpu=gfx1200 -mattr=-real-true16 -mattr=-flat-for-global < %s | FileCheck --check-prefixes=GFX11PLUS,GFX11PLUS-FAKE16,GFX12,GFX12-FAKE16 %s
...
; GFX9-NEXT:    v_sub_f32_e32 v2, s2, v0
; GFX9-NEXT:    v_cmp_ge_f32_e64 s[0:1], |v2|, 0.5
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_trunc_f32_e32 v0, s3
; GFX11-NEXT:    v_trunc_f32_e32 v1, s2
; GFX11-NEXT:    v_trunc_f32_e32 v4, s1
...
; GFX6:       ; %bb.0:
; GFX6-NEXT:    s_load_dwordx8 s[8:15], s[4:5], 0x11
; GFX6-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
...
; GFX8:       ; %bb.0:
; GFX8-NEXT:    s_load_dwordx8 s[8:15], s[4:5], 0x44
; GFX8-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
...
; GFX8-NEXT:    v_add_f32_e32 v0, v0, v4
; GFX8-NEXT:    v_trunc_f32_e32 v4, s15
; GFX8-NEXT:    v_sub_f32_e32 v5, s15, v4
; GFX8-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v5|, 0.5
; GFX8-NEXT:    v_cndmask_b32_e64 v5, 0, 1.0, s[4:5]
; GFX8-NEXT:    v_mov_b32_e32 v6, s15
; GFX8-NEXT:    v_bfi_b32 v5, s6, v5, v6
; GFX8-NEXT:    v_add_f32_e32 v7, v4, v5
; GFX8-NEXT:    v_trunc_f32_e32 v4, s14
; GFX8-NEXT:    v_sub_f32_e32 v5, s14, v4
; GFX8-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v5|, 0.5
; GFX8-NEXT:    v_cndmask_b32_e64 v5, 0, 1.0, s[4:5]
; GFX8-NEXT:    v_mov_b32_e32 v6, s14
; GFX8-NEXT:    v_bfi_b32 v5, s6, v5, v6
; GFX8-NEXT:    v_add_f32_e32 v6, v4, v5
; GFX8-NEXT:    v_trunc_f32_e32 v4, s13
; GFX8-NEXT:    v_sub_f32_e32 v5, s13, v4
; GFX8-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v5|, 0.5
; GFX8-NEXT:    v_cndmask_b32_e64 v5, 0, 1.0, s[4:5]
; GFX8-NEXT:    v_mov_b32_e32 v8, s13
; GFX8-NEXT:    v_bfi_b32 v5, s6, v5, v8
; GFX8-NEXT:    v_add_f32_e32 v5, v4, v5
; GFX8-NEXT:    v_trunc_f32_e32 v4, s12
; GFX8-NEXT:    v_sub_f32_e32 v8, s12, v4
; GFX8-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v8|, 0.5
; GFX8-NEXT:    v_cndmask_b32_e64 v8, 0, 1.0, s[4:5]
; GFX8-NEXT:    v_mov_b32_e32 v9, s12
; GFX8-NEXT:    v_bfi_b32 v8, s6, v8, v9
; GFX8-NEXT:    v_add_f32_e32 v4, v4, v8
; GFX8-NEXT:    buffer_store_dwordx4 v[4:7], off, s[0:3], 0 offset:16
; GFX8-NEXT:    buffer_store_dwordx4 v[0:3], off, s[0:3], 0
; GFX8-NEXT:    s_endpgm
;
; GFX9-LABEL: round_v8f32:
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_load_dwordx8 s[8:15], s[4:5], 0x44
; GFX9-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX9-NEXT:    s_brev_b32 s6, -2
; GFX9-NEXT:    s_mov_b32 s3, 0xf000
; GFX9-NEXT:    s_mov_b32 s2, -1
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    s_load_b256 s[8:15], s[4:5], 0x44
; GFX11-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-NEXT:    s_mov_b32 s3, 0x31016000
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_trunc_f32_e32 v0, s11
; GFX11-NEXT:    v_trunc_f32_e32 v1, s10
...
; GFX8-NEXT:    s_mov_b32 s3, 0xf000
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    v_trunc_f16_e32 v1, s6
; GFX8-NEXT:    v_sub_f16_e32 v2, s6, v1
...
; GFX9-NEXT:    s_mov_b32 s3, 0xf000
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    v_trunc_f16_e32 v1, s6
; GFX9-NEXT:    v_sub_f16_e32 v2, s6, v1
