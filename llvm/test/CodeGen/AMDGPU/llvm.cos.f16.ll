...
; GFX11-TRUE16-NEXT:    v_mul_f16_e32 v0.h, 0.15915494, v1.l
; GFX11-TRUE16-NEXT:    v_cos_f16_e32 v0.l, v0.l
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX12-TRUE16-NEXT:    s_wait_kmcnt 0x0
; GFX12-TRUE16-NEXT:    global_load_b32 v0, v2, s[2:3]
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v1, 16, v0
; GFX12-TRUE16-NEXT:    v_mul_f16_e32 v0.l, 0.15915494, v0.l
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-TRUE16-NEXT:    v_mul_f16_e32 v0.h, 0.15915494, v1.l
; GFX12-TRUE16-NEXT:    v_cos_f16_e32 v0.l, v0.l
...
; GFX12-TRUE16-NEXT:    global_store_b32 v2, v0, s[0:1]
; GFX12-TRUE16-NEXT:    s_endpgm
;
