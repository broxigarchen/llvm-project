...
; SI-NEXT:    s_lshr_b32 s5, s4, 16
; SI-NEXT:    s_and_b32 s6, s6, 0xffe
; SI-NEXT:    s_and_b32 s7, s3, 0x1ff
; SI-NEXT:    s_or_b32 s2, s7, s2
...
; SI-NEXT:    s_cselect_b32 s7, s2, 0x7c00
; SI-NEXT:    s_cmpk_eq_i32 s3, 0x40f
; SI-NEXT:    s_cselect_b32 s3, s7, s6
; SI-NEXT:    s_lshr_b32 s6, s1, 8
; SI-NEXT:    s_and_b32 s6, s6, 0xffe
; SI-NEXT:    s_and_b32 s7, s1, 0x1ff
; SI-NEXT:    s_or_b32 s0, s7, s0
; SI-NEXT:    s_cselect_b32 s0, 1, 0
; SI-NEXT:    s_bfe_u32 s1, s1, 0xb0014
; SI-NEXT:    s_sub_i32 s7, 0x3f1, s1
; SI-NEXT:    s_or_b32 s0, s6, s0
; SI-NEXT:    v_med3_i32 v0, s7, 0, 13
; SI-NEXT:    s_or_b32 s6, s0, 0x1000
; SI-NEXT:    v_readfirstlane_b32 s7, v0
; SI-NEXT:    s_lshr_b32 s8, s6, s7
; SI-NEXT:    s_lshl_b32 s7, s8, s7
; SI-NEXT:    s_cmp_lg_u32 s7, s6
...
; SI-NEXT:    s_or_b32 s0, s0, s1
; SI-NEXT:    s_and_b32 s1, s3, 0x7fff
...
; VI-NEXT:    s_movk_i32 s2, 0x7e00
; VI-NEXT:    s_cselect_b32 s6, s2, 0x7c00
; VI-NEXT:    s_cmpk_eq_i32 s3, 0x40f
; VI-NEXT:    s_cselect_b32 s3, s6, s5
; VI-NEXT:    s_lshr_b32 s5, s1, 8
; VI-NEXT:    s_lshl_b32 s3, s3, 16
; VI-NEXT:    s_and_b32 s5, s5, 0xffe
; VI-NEXT:    s_and_b32 s6, s1, 0x1ff
; VI-NEXT:    s_or_b32 s0, s6, s0
; VI-NEXT:    s_cselect_b32 s0, 1, 0
; VI-NEXT:    s_bfe_u32 s1, s1, 0xb0014
; VI-NEXT:    s_sub_i32 s6, 0x3f1, s1
; VI-NEXT:    s_or_b32 s0, s5, s0
; VI-NEXT:    v_med3_i32 v0, s6, 0, 13
; VI-NEXT:    s_or_b32 s5, s0, 0x1000
; VI-NEXT:    v_readfirstlane_b32 s6, v0
; VI-NEXT:    s_lshr_b32 s7, s5, s6
; VI-NEXT:    s_lshl_b32 s6, s7, s6
; VI-NEXT:    s_cmp_lg_u32 s6, s5
...
; VI-NEXT:    s_cselect_b32 s5, s5, 0x7c00
; VI-NEXT:    s_cmp_lg_u32 s0, 0
; VI-NEXT:    s_cselect_b32 s0, s2, 0x7c00
; VI-NEXT:    s_cmpk_eq_i32 s1, 0x40f
; VI-NEXT:    s_cselect_b32 s0, s0, s5
; VI-NEXT:    s_and_b32 s0, s0, 0x7fff
...
; GFX9-NEXT:    s_cselect_b32 s7, s2, 0x7c00
...
; GFX9-NEXT:    s_and_b32 s5, s5, 0xffe
; GFX9-NEXT:    s_and_b32 s6, s1, 0x1ff
; GFX9-NEXT:    s_or_b32 s0, s6, s0
; GFX9-NEXT:    s_cselect_b32 s0, 1, 0
; GFX9-NEXT:    s_bfe_u32 s6, s1, 0xb0014
; GFX9-NEXT:    s_sub_i32 s7, 0x3f1, s6
; GFX9-NEXT:    s_or_b32 s0, s5, s0
; GFX9-NEXT:    v_med3_i32 v0, s7, 0, 13
; GFX9-NEXT:    s_or_b32 s5, s0, 0x1000
; GFX9-NEXT:    v_readfirstlane_b32 s7, v0
; GFX9-NEXT:    s_lshr_b32 s8, s5, s7
; GFX9-NEXT:    s_lshl_b32 s7, s8, s7
; GFX9-NEXT:    s_cmp_lg_u32 s7, s5
...
; GFX9-NEXT:    s_cselect_b32 s5, s5, 0x7c00
; GFX9-NEXT:    s_cmp_lg_u32 s0, 0
; GFX9-NEXT:    s_cselect_b32 s0, s2, 0x7c00
; GFX9-NEXT:    s_cmpk_eq_i32 s6, 0x40f
; GFX9-NEXT:    s_cselect_b32 s0, s0, s5
...
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v9, 0x7c00, v9, vcc_lo
; GFX11-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, 0x40f, v13
...
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v17, 0x1000, v4
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX11-TRUE16-NEXT:    v_add_nc_u32_e32 v10, 0xfffffc10, v10
; GFX11-TRUE16-NEXT:    v_add_nc_u32_e32 v14, 0xfffffc10, v15
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v15, v13, v17
; GFX11-TRUE16-NEXT:    v_lshl_or_b32 v18, v10, 12, v6
; GFX11-TRUE16-NEXT:    v_cmp_gt_i32_e32 vcc_lo, 1, v10
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-TRUE16-NEXT:    v_lshlrev_b32_e32 v13, v13, v15
...
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v15, v19, v17
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v13, v16, v13, vcc_lo
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v16, 0x1000, v2
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v17, 8, v1
; GFX11-TRUE16-NEXT:    v_bfe_u32 v19, v1, 20, 11
...
; GFX11-TRUE16-NEXT:    v_dual_cndmask_b32 v11, 0x7c00, v11 :: v_dual_lshlrev_b32 v18, v18, v20
; GFX11-TRUE16-NEXT:    v_and_b32_e32 v15, 7, v13
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v21, 0x1000, v0
; GFX11-TRUE16-NEXT:    v_med3_i32 v17, v17, 0, 13
...
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v15, 2, v16
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v16, 2, v17
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc_lo
; GFX11-TRUE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v4
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-TRUE16-NEXT:    v_add_nc_u32_e32 v13, v15, v13
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v11, v11, v20
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v4, 0x7c00, v18, vcc_lo
...
; GFX11-TRUE16-NEXT:    v_cmp_gt_i32_e32 vcc_lo, 31, v19
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v10, 0x7c00, v10, vcc_lo
; GFX11-TRUE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v0
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v0, 0x7c00, v18, vcc_lo
