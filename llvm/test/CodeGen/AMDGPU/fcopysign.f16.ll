...
; GFX11-TRUE16-NEXT:    v_bfi_b32 v1, 0x7fff, s2, s2
...
; GFX11-TRUE16-NEXT:    v_bfi_b32 v0, 0x7fff, s2, v0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
...
; GFX11-TRUE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-TRUE16-NEXT:    s_lshr_b32 s1, s2, 16
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v0, s2 :: v_dual_mov_b32 v1, s1
...
; GFX11-TRUE16-NEXT:    v_bfi_b32 v1, 0x7fff, s1, v1
; GFX11-TRUE16-NEXT:    v_and_b32_e32 v3, 0xffff, v0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_bfi_b32 v2, 0x7fff, s0, v2
...
; GFX11-TRUE16-NEXT:    s_load_b64 s[4:5], s[4:5], 0x24
; GFX11-TRUE16-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v5, 0 :: v_dual_mov_b32 v0, s3
; GFX11-TRUE16-NEXT:    v_mov_b32_e32 v1, s2
; GFX11-TRUE16-NEXT:    s_lshr_b32 s3, s3, 16
; GFX11-TRUE16-NEXT:    s_lshr_b32 s2, s2, 16
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v2, s3 :: v_dual_mov_b32 v3, s2
; GFX11-TRUE16-NEXT:    v_bfi_b32 v0, 0x7fff, s0, v0
...
; GFX11-TRUE16-NEXT:    v_bfi_b32 v3, 0x7fff, s0, v3
