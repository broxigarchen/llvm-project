...
; GFX942-NEXT:    s_nop 0
; GFX942-NEXT:    v_cndmask_b32_e32 v6, -1, v4, vcc
; GFX942-NEXT:    scratch_load_dwordx2 v[0:1], v6, off
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_max_f64 v[4:5], v[0:1], v[0:1]
; GFX942-NEXT:    v_min_f64 v[2:3], v[4:5], v[2:3]
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_min_f64 v[2:3], v[4:5], v[2:3]
...
; GFX8-NEXT:    v_min_f64 v[2:3], v[4:5], v[2:3]
...
; GFX942-NEXT:    s_and_saveexec_b64 s[0:1], vcc
; GFX942-NEXT:    s_xor_b64 s[0:1], exec, s[0:1]
; GFX942-NEXT:    s_cbranch_execnz .LBB22_3
; GFX942-NEXT:  ; %bb.1: ; %Flow
; GFX942-NEXT:    s_andn2_saveexec_b64 s[0:1], s[0:1]
; GFX942-NEXT:    s_cbranch_execnz .LBB22_4
; GFX942-NEXT:  .LBB22_2: ; %atomicrmw.phi
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-NEXT:    s_and_saveexec_b64 s[0:1], vcc
; GFX942-NEXT:    s_xor_b64 s[0:1], exec, s[0:1]
; GFX942-NEXT:    s_cbranch_execnz .LBB23_3
; GFX942-NEXT:  ; %bb.1: ; %Flow
; GFX942-NEXT:    s_andn2_saveexec_b64 s[0:1], s[0:1]
; GFX942-NEXT:    s_cbranch_execnz .LBB23_4
; GFX942-NEXT:  .LBB23_2: ; %atomicrmw.phi
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-NEXT:  ; %bb.1: ; %Flow
; GFX942-NEXT:    s_andn2_saveexec_b64 s[0:1], s[0:1]
; GFX942-NEXT:    s_cbranch_execnz .LBB24_4
; GFX942-NEXT:  .LBB24_2: ; %atomicrmw.phi
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
...
; GFX942-NEXT:  ; %bb.1: ; %Flow
; GFX942-NEXT:    s_andn2_saveexec_b64 s[0:1], s[0:1]
; GFX942-NEXT:    s_cbranch_execnz .LBB25_4
; GFX942-NEXT:  .LBB25_2: ; %atomicrmw.phi
; GFX942-NEXT:    s_or_b64 exec, exec, s[0:1]
; GFX942-NEXT:    s_setpc_b64 s[30:31]
...
; GFX7-NEXT:    v_min_f32_e32 v7, v7, v2
...
; GFX7-NEXT:  ; %bb.2: ; %atomicrmw.end
; GFX7-NEXT:    s_or_b64 exec, exec, s[4:5]
; GFX7-NEXT:    v_and_b32_e32 v0, 0xffff, v4
