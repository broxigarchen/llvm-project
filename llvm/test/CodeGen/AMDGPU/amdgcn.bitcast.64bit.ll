...
; VI-NEXT:    v_lshlrev_b16_e32 v1, 8, v10
...
; GFX9-NEXT:    v_perm_b32 v0, v9, v10, s6
; GFX9-NEXT:    v_perm_b32 v1, v2, v3, s6
...
; GFX9-NEXT:    v_lshlrev_b16_e32 v1, 8, v10
...
; GFX11-FAKE16:       ; %bb.0:
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v10, v1 :: v_dual_mov_b32 v9, v0
; GFX11-FAKE16-NEXT:    s_mov_b32 s0, exec_lo
...
; GFX11-FAKE16-NEXT:    v_perm_b32 v0, v9, v10, 0xc0c0004
...
; GFX11-FAKE16-NEXT:    v_lshlrev_b16 v4, 8, v10
...
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v0, v4, v0
...
; SI-NEXT:  ; %bb.1: ; %cmp.false
; SI-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; SI-NEXT:    v_or_b32_e32 v4, v1, v7
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; SI-NEXT:    v_alignbit_b32 v5, v4, v6, 16
; SI-NEXT:    v_or_b32_e32 v2, v0, v6
; SI-NEXT:    ; implicit-def: $vgpr0
; SI-NEXT:    ; implicit-def: $vgpr6
; SI-NEXT:    ; implicit-def: $vgpr1
; SI-NEXT:    ; implicit-def: $vgpr7
...
; SI-NEXT:    v_or_b32_e32 v0, v0, v2
; SI-NEXT:    v_alignbit_b32 v4, v1, v2, 16
; SI-NEXT:  .LBB90_2: ; %end
; SI-NEXT:    s_or_b64 exec, exec, s[4:5]
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v0
...
; GFX11-TRUE16-NEXT:    v_perm_b32 v1, v4, v3, 0x5040302
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v2, v8, v10, vcc_lo
; GFX11-TRUE16-NEXT:    v_perm_b32 v0, v5, v2, 0x5040302
...
; SI-NEXT:    v_or_b32_e32 v4, v1, v10
; SI-NEXT:    v_alignbit_b32 v3, v4, v0, 24
; SI-NEXT:    v_alignbit_b32 v2, v4, v0, 16
; SI-NEXT:    v_alignbit_b32 v1, v4, v0, 8
; SI-NEXT:    v_lshrrev_b32_e32 v5, 8, v4
...
; SI-NEXT:  ; %bb.2: ; %Flow
; SI-NEXT:    s_andn2_saveexec_b64 s[4:5], s[4:5]
; SI-NEXT:    s_cbranch_execz .LBB100_4
; SI-NEXT:  ; %bb.3: ; %cmp.true
...
; SI-NEXT:    v_or_b32_e32 v10, v2, v0
...
; GFX9-NEXT:    v_cmp_u_f32_e32 vcc, v1, v1
; GFX9-NEXT:    v_cndmask_b32_e32 v1, v2, v3, vcc
; GFX9-NEXT:    v_and_b32_e32 v2, 0xffff0000, v9
; GFX9-NEXT:    v_add_f32_e32 v2, 0x40c00000, v2
; GFX9-NEXT:    v_bfe_u32 v3, v2, 16, 1
; GFX9-NEXT:    v_add3_u32 v3, v3, v2, s6
; GFX9-NEXT:    v_or_b32_e32 v4, 0x400000, v2
...
; GFX9-NEXT:    v_perm_b32 v11, v2, v3, s7
...
; GFX9-NEXT:    s_pack_lh_b32_b16 s4, 0, s17
; GFX9-NEXT:    v_or_b32_sdwa v9, v3, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
...
; GFX9-NEXT:    v_or_b32_sdwa v10, v1, v8 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
