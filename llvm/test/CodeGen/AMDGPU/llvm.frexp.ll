...
; GFX11-SDAG-TRUE16-NEXT:    v_frexp_exp_i16_f16_e32 v3.l, v1.l
; GFX11-SDAG-TRUE16-NEXT:    v_frexp_mant_f16_e32 v0.h, v1.l
...
; GFX12-SDAG-TRUE16-NEXT:    v_frexp_exp_i16_f16_e32 v3.l, v1.l
; GFX12-SDAG-TRUE16-NEXT:    v_frexp_mant_f16_e32 v0.h, v1.l
...
; GFX6-GISEL-NEXT:    v_cndmask_b32_e32 v4, v2, v4, vcc
...
; GFX6-GISEL-NEXT:    v_cvt_f16_f32_e32 v0, v0
; GFX6-GISEL-NEXT:    v_cvt_f16_f32_e32 v3, v4
...
; GFX11-SDAG-TRUE16-NEXT:    v_frexp_exp_i16_f16_e32 v1.l, v1.l
; GFX11-SDAG-TRUE16-NEXT:    v_bfe_i32 v0, v0, 0, 16
; GFX11-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-SDAG-TRUE16-NEXT:    v_bfe_i32 v1, v1, 0, 16
; GFX11-SDAG-TRUE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX12-SDAG-TRUE16-NEXT:    v_frexp_exp_i16_f16_e32 v1.l, v1.l
; GFX12-SDAG-TRUE16-NEXT:    v_bfe_i32 v0, v0, 0, 16
; GFX12-SDAG-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX12-SDAG-TRUE16-NEXT:    v_bfe_i32 v1, v1, 0, 16
; GFX12-SDAG-TRUE16-NEXT:    s_setpc_b64 s[30:31]
...
; GFX6-GISEL-NEXT:    v_mov_b32_e32 v2, 0x7f800000
; GFX6-GISEL-NEXT:    v_frexp_exp_i32_f32_e32 v0, v1
; GFX6-GISEL-NEXT:    v_cmp_lt_f32_e64 vcc, |v1|, v2
; GFX6-GISEL-NEXT:    v_cndmask_b32_e32 v0, 0, v0, vcc
; GFX6-GISEL-NEXT:    v_frexp_exp_i32_f32_e32 v1, v3
; GFX6-GISEL-NEXT:    v_cmp_lt_f32_e64 vcc, |v3|, v2
; GFX6-GISEL-NEXT:    v_cndmask_b32_e32 v1, 0, v1, vcc
; GFX6-GISEL-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX6-SDAG-NEXT:    s_mov_b32 s4, 0x7ff00000
...
; GFX6-SDAG-NEXT:    v_cmp_gt_i32_e32 vcc, s4, v4
; GFX6-SDAG-NEXT:    v_cndmask_b32_e32 v0, v0, v2, vcc
...
; GFX6-SDAG-NEXT:    v_frexp_exp_i32_f64_e32 v0, v[0:1]
; GFX6-SDAG-NEXT:    v_cmp_gt_i32_e32 vcc, s4, v2
; GFX6-SDAG-NEXT:    v_cndmask_b32_e32 v0, 0, v0, vcc
; GFX6-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX6-SDAG:       ; %bb.0:
; GFX6-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX6-SDAG-NEXT:    v_and_b32_e32 v6, 0x7fffffff, v1
; GFX6-SDAG-NEXT:    s_mov_b32 s4, 0x7ff00000
...
; GFX6-SDAG-NEXT:    v_cndmask_b32_e64 v5, 0, v1, s[4:5]
; GFX6-SDAG-NEXT:    v_mov_b32_e32 v0, v8
; GFX6-SDAG-NEXT:    v_mov_b32_e32 v1, v9
; GFX6-SDAG-NEXT:    v_mov_b32_e32 v2, v6
; GFX6-SDAG-NEXT:    v_mov_b32_e32 v3, v7
; GFX6-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX6-SDAG-NEXT:    v_frexp_exp_i32_f64_e32 v0, v[0:1]
; GFX6-SDAG-NEXT:    v_cmp_gt_i32_e32 vcc, s4, v4
; GFX6-SDAG-NEXT:    v_and_b32_e32 v1, 0x7fffffff, v3
; GFX6-SDAG-NEXT:    v_frexp_exp_i32_f64_e32 v2, v[2:3]
; GFX6-SDAG-NEXT:    v_cndmask_b32_e32 v0, 0, v0, vcc
; GFX6-SDAG-NEXT:    v_cmp_gt_i32_e32 vcc, s4, v1
; GFX6-SDAG-NEXT:    v_cndmask_b32_e32 v1, 0, v2, vcc
; GFX6-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
