...
; GFX950:    v_dot2_f32_bf16 v0, v0, v1, v2 clamp
;
; GFX11PLUS-LABEL: v_fdot2_f32_bf16_opsel_hi_a_clamp:
; GFX11PLUS:  ; %bb.0:
; GFX11PLUS:    v_mov_b16_e32 v0.h, v0.l
; GFX11PLUS:    v_dot2_f32_bf16 v0, v0, v1, v2 clamp
  %shuf = shufflevector <2 x bfloat> %a, <2 x bfloat> poison, <2 x i32> <i32 0, i32 0>
...
; GFX950:    v_dot2_f32_bf16 v0, v0, v1, v2 clamp
;
; GFX11PLUS-LABEL: v_fdot2_f32_bf16_opsel_hi_b_clamp:
; GFX11PLUS:  ; %bb.0:
; GFX11PLUS:    v_mov_b16_e32 v1.h, v1.l
; GFX11PLUS:    v_dot2_f32_bf16 v0, v0, v1, v2 clamp
  %shuf = shufflevector <2 x bfloat> %b, <2 x bfloat> poison, <2 x i32> <i32 0, i32 0>
...
; GFX11PLUS:  ; %bb.0:
; GFX11PLUS:    v_lshrrev_b32_e32 v6, 16, v0
; GFX11PLUS:    v_xor_b16 v0.l, 0x8000, v0.l
; GFX11PLUS:    v_mov_b16_e32 v0.h, v6.l
; GFX11PLUS:    v_dot2_f32_bf16 v0, v0, v1, v2
; GFX11PLUS:    v_dot2_f32_bf16 v1, v3, v4, v5
; GFX11PLUS:    v_add_f32_e32 v0, v0, v1
  %a_lo = extractelement <2 x bfloat> %a, i32 0
...
; GFX11PLUS:  ; %bb.0:
; GFX11PLUS:    v_lshrrev_b32_e32 v6, 16, v0
; GFX11PLUS:    v_xor_b16 v0.h, 0x8000, v6.l
; GFX11PLUS:    v_dot2_f32_bf16 v0, v0, v1, v2
; GFX11PLUS:    v_dot2_f32_bf16 v1, v3, v4, v5
; GFX11PLUS:    v_add_f32_e32 v0, v0, v1
  %a_hi = extractelement <2 x bfloat> %a, i32 1
...
; GFX11PLUS:  ; %bb.0:
; GFX11PLUS:    v_lshrrev_b32_e32 v6, 16, v1
; GFX11PLUS:    v_xor_b16 v1.l, 0x8000, v1.l
; GFX11PLUS:    v_mov_b16_e32 v1.h, v6.l
; GFX11PLUS:    v_dot2_f32_bf16 v0, v0, v1, v2
; GFX11PLUS:    v_dot2_f32_bf16 v1, v3, v4, v5
; GFX11PLUS:    v_add_f32_e32 v0, v0, v1
  %b_lo = extractelement <2 x bfloat> %b, i32 0
...
; GFX11PLUS:  ; %bb.0:
; GFX11PLUS:    v_lshrrev_b32_e32 v6, 16, v1
; GFX11PLUS:    v_xor_b16 v1.h, 0x8000, v6.l
; GFX11PLUS:    v_dot2_f32_bf16 v0, v0, v1, v2
; GFX11PLUS:    v_dot2_f32_bf16 v1, v3, v4, v5
; GFX11PLUS:    v_add_f32_e32 v0, v0, v1
  %b_hi = extractelement <2 x bfloat> %b, i32 1
...
define float @v_fdot2_f32_bf16_inline_literal_a_y(<2 x bfloat> %a, <2 x bfloat> %b, float %c, <2 x bfloat> %d, <2 x bfloat> %e, float %f) {
; GFX950-LABEL: v_fdot2_f32_bf16_inline_literal_a_y:
; GFX950:  ; %bb.0:
; GFX950:    v_dot2c_f32_bf16_e32 v2, v0, v1
; GFX950:    v_dot2c_f32_bf16_e32 v5, 0x40004000, v4
; GFX950:    v_add_f32_e32 v0, v2, v5
;
...
define float @v_fdot2_f32_bf16_inline_literal_a_xy(<2 x bfloat> %a, <2 x bfloat> %b, float %c, <2 x bfloat> %d, <2 x bfloat> %e, float %f) {
; GFX950-LABEL: v_fdot2_f32_bf16_inline_literal_a_xy:
; GFX950:  ; %bb.0:
; GFX950:    v_dot2c_f32_bf16_e32 v2, 0x40004000, v1
; GFX950:    v_dot2c_f32_bf16_e32 v5, 0x40004000, v4
; GFX950:    v_add_f32_e32 v0, v2, v5
;
...
define float @v_fdot2_f32_bf16_inline_literal_b_x(<2 x bfloat> %a, <2 x bfloat> %b, float %c, <2 x bfloat> %d, <2 x bfloat> %e, float %f) {
; GFX950-LABEL: v_fdot2_f32_bf16_inline_literal_b_x:
; GFX950:  ; %bb.0:
; GFX950:    v_dot2c_f32_bf16_e32 v2, 0x40004000, v0
; GFX950:    v_dot2c_f32_bf16_e32 v5, v4, v3
; GFX950:    v_add_f32_e32 v0, v2, v5
;
...
define float @v_fdot2_f32_bf16_inline_literal_b_y(<2 x bfloat> %a, <2 x bfloat> %b, float %c, <2 x bfloat> %d, <2 x bfloat> %e, float %f) {
; GFX950-LABEL: v_fdot2_f32_bf16_inline_literal_b_y:
; GFX950:  ; %bb.0:
; GFX950:    v_dot2c_f32_bf16_e32 v2, v1, v0
; GFX950:    v_dot2c_f32_bf16_e32 v5, 0x40004000, v3
; GFX950:    v_add_f32_e32 v0, v2, v5
;
...
define float @v_fdot2_f32_bf16_inline_literal_b_xy(<2 x bfloat> %a, <2 x bfloat> %b, float %c, <2 x bfloat> %d, <2 x bfloat> %e, float %f) {
; GFX950-LABEL: v_fdot2_f32_bf16_inline_literal_b_xy:
; GFX950:  ; %bb.0:
; GFX950:    v_dot2c_f32_bf16_e32 v2, 0x40004000, v0
; GFX950:    v_dot2c_f32_bf16_e32 v5, 0x40004000, v3
; GFX950:    v_add_f32_e32 v0, v2, v5
