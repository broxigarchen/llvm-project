...
; GFX7-ISEL-LABEL: test_s_unsigned_v2f64_v2i1:
; GFX7-ISEL:       ; %bb.0:
; GFX7-ISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX7-ISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX7-GI-LABEL: test_s_unsigned_v2f64_v2i1:
; GFX7-GI:       ; %bb.0:
; GFX7-GI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX7-GI-NEXT:    s_min_u32 s4, s4, 1
; GFX7-GI-NEXT:    s_min_u32 s5, s5, 1
...
; GFX11-NEXT:    s_setpc_b64 s[30:31]
;
; GFX12-ISEL-LABEL: test_s_unsigned_v2f64_v2i1:
; GFX12-ISEL:       ; %bb.0:
; GFX12-ISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-ISEL-NEXT:    s_wait_expcnt 0x0
; GFX12-ISEL-NEXT:    s_wait_samplecnt 0x0
...
; GFX12-ISEL-NEXT:    v_min_u32_e32 v0, 1, v0
; GFX12-ISEL-NEXT:    v_min_u32_e32 v1, 1, v1
; GFX12-ISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX12-GI-LABEL: test_s_unsigned_v2f64_v2i1:
; GFX12-GI:       ; %bb.0:
; GFX12-GI-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-GI-NEXT:    s_wait_expcnt 0x0
; GFX12-GI-NEXT:    s_wait_samplecnt 0x0
...
; GFX7-GI-NEXT:    v_readfirstlane_b32 s4, v0
; GFX7-GI-NEXT:    v_readfirstlane_b32 s5, v1
; GFX7-GI-NEXT:    s_min_u32 s4, s4, 0xff
; GFX7-GI-NEXT:    s_min_u32 s5, s5, 0xff
; GFX7-GI-NEXT:    v_mov_b32_e32 v0, s4
; GFX7-GI-NEXT:    v_mov_b32_e32 v1, s5
; GFX7-GI-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-GI-NEXT:    v_readfirstlane_b32 s7, v6
; GFX7-GI-NEXT:    v_readfirstlane_b32 s11, v4
; GFX7-GI-NEXT:    v_cvt_u32_f64_e32 v0, v[0:1]
; GFX7-GI-NEXT:    v_cvt_u32_f64_e32 v1, v[2:3]
; GFX7-GI-NEXT:    v_readfirstlane_b32 s6, v0
; GFX7-GI-NEXT:    s_cselect_b64 s[6:7], 0, s[6:7]
; GFX7-GI-NEXT:    s_or_b64 s[12:13], vcc, vcc
; GFX7-GI-NEXT:    v_readfirstlane_b32 s10, v1
; GFX7-GI-NEXT:    s_cselect_b64 s[6:7], -1, s[6:7]
; GFX7-GI-NEXT:    s_or_b64 s[8:9], s[8:9], s[8:9]
; GFX7-GI-NEXT:    s_cselect_b64 s[8:9], 0, s[10:11]
; GFX7-GI-NEXT:    s_or_b64 s[4:5], s[4:5], s[4:5]
; GFX7-GI-NEXT:    s_cselect_b64 s[4:5], -1, s[8:9]
; GFX7-GI-NEXT:    v_mov_b32_e32 v0, s6
; GFX7-GI-NEXT:    v_mov_b32_e32 v1, s7
; GFX7-GI-NEXT:    v_mov_b32_e32 v2, s4
; GFX7-GI-NEXT:    v_mov_b32_e32 v3, s5
; GFX7-GI-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-GI-NEXT:    v_dual_mov_b32 v8, -1 :: v_dual_mov_b32 v9, 0x43efffff
; GFX12-GI-NEXT:    v_cmp_nge_f64_e64 s4, s[0:1], 0
; GFX12-GI-NEXT:    v_cmp_gt_f64_e32 vcc_lo, s[0:1], v[8:9]
; GFX12-GI-NEXT:    v_cmp_nge_f64_e64 s1, s[2:3], 0
...
; GFX11-TRUE16-NEXT:    v_cvt_u16_f16_e32 v1.l, v2.l
; GFX11-TRUE16-NEXT:    v_cvt_u16_f16_e32 v1.h, v3.l
; GFX11-TRUE16-NEXT:    v_min_u16 v0.l, v0.l, 1
; GFX11-TRUE16-NEXT:    v_min_u16 v2.l, v0.h, 1
; GFX11-TRUE16-NEXT:    v_min_u16 v1.l, v1.l, 1
...
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v1.l, v2.l
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v1.h, v3.l
; GFX12-TRUE16-NEXT:    v_min_u16 v0.l, v0.l, 1
; GFX12-TRUE16-NEXT:    v_min_u16 v2.l, v0.h, 1
; GFX12-TRUE16-NEXT:    v_min_u16 v1.l, v1.l, 1
...
; GFX11-TRUE16-NEXT:    v_cvt_u16_f16_e32 v1.l, v1.l
; GFX11-TRUE16-NEXT:    v_cvt_u16_f16_e32 v0.l, v0.l
; GFX11-TRUE16-NEXT:    v_cvt_u16_f16_e32 v0.h, v2.l
; GFX11-TRUE16-NEXT:    v_cvt_u16_f16_e32 v1.h, v3.l
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v1.l, v1.l
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v0.l, v0.l
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v0.h, v2.l
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v1.h, v3.l
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:    v_cvt_u32_f32_e32 v1, v4
...
; GFX12-TRUE16-NEXT:    v_cvt_u32_f32_e32 v1, v4
...
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v2, v2
; GFX7-GI-NEXT:    s_min_u32 s4, s5, 1
; GFX7-GI-NEXT:    v_readfirstlane_b32 s5, v1
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX7-GI-NEXT:    v_readfirstlane_b32 s6, v2
; GFX7-GI-NEXT:    s_min_u32 s5, s5, 1
; GFX7-GI-NEXT:    s_min_u32 s6, s6, 1
; GFX7-GI-NEXT:    v_readfirstlane_b32 s7, v0
; GFX7-GI-NEXT:    s_min_u32 s7, s7, 1
; GFX7-GI-NEXT:    v_mov_b32_e32 v0, s4
; GFX7-GI-NEXT:    v_mov_b32_e32 v1, s5
...
; GFX7-GI-NEXT:    v_cvt_f32_f16_e32 v0, s4
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v2, v2
; GFX7-GI-NEXT:    s_min_u32 s4, s5, 0xff
; GFX7-GI-NEXT:    v_readfirstlane_b32 s5, v1
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX7-GI-NEXT:    v_readfirstlane_b32 s6, v2
; GFX7-GI-NEXT:    s_min_u32 s5, s5, 0xff
; GFX7-GI-NEXT:    s_min_u32 s6, s6, 0xff
; GFX7-GI-NEXT:    v_readfirstlane_b32 s7, v0
; GFX7-GI-NEXT:    s_min_u32 s7, s7, 0xff
; GFX7-GI-NEXT:    v_mov_b32_e32 v0, s4
; GFX7-GI-NEXT:    v_mov_b32_e32 v1, s5
; GFX7-GI-NEXT:    v_mov_b32_e32 v2, s6
; GFX7-GI-NEXT:    v_mov_b32_e32 v3, s7
...
; GFX11-TRUE16-NEXT:    v_cvt_u16_f16_e32 v2.l, v0.l
; GFX11-TRUE16-NEXT:    v_cvt_u16_f16_e32 v2.h, v1.l
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v6, 16, v0
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v7, 16, v1
; GFX11-TRUE16-NEXT:    v_cvt_u16_f16_e32 v4.l, v5.l
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v5, 16, v5
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v8, 16, v3
; GFX11-TRUE16-NEXT:    v_min_u16 v0.l, v2.l, 1
; GFX11-TRUE16-NEXT:    v_min_u16 v2.l, v2.h, 1
; GFX11-TRUE16-NEXT:    v_cvt_u16_f16_e32 v0.h, v3.l
; GFX11-TRUE16-NEXT:    v_cvt_u16_f16_e32 v1.l, v6.l
; GFX11-TRUE16-NEXT:    v_cvt_u16_f16_e32 v1.h, v7.l
; GFX11-TRUE16-NEXT:    v_cvt_u16_f16_e32 v2.h, v5.l
; GFX11-TRUE16-NEXT:    v_cvt_u16_f16_e32 v3.h, v8.l
; GFX11-TRUE16-NEXT:    v_min_u16 v4.l, v4.l, 1
; GFX11-TRUE16-NEXT:    v_min_u16 v6.l, v0.h, 1
; GFX11-TRUE16-NEXT:    v_min_u16 v1.l, v1.l, 1
; GFX11-TRUE16-NEXT:    v_min_u16 v3.l, v1.h, 1
...
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v2.l, v0.l
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v2.h, v1.l
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v6, 16, v0
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v7, 16, v1
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v4.l, v5.l
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v5, 16, v5
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v8, 16, v3
; GFX12-TRUE16-NEXT:    v_min_u16 v0.l, v2.l, 1
; GFX12-TRUE16-NEXT:    v_min_u16 v2.l, v2.h, 1
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v0.h, v3.l
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v1.l, v6.l
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v1.h, v7.l
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v2.h, v5.l
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v3.h, v8.l
; GFX12-TRUE16-NEXT:    v_min_u16 v4.l, v4.l, 1
; GFX12-TRUE16-NEXT:    v_min_u16 v6.l, v0.h, 1
; GFX12-TRUE16-NEXT:    v_min_u16 v1.l, v1.l, 1
; GFX12-TRUE16-NEXT:    v_min_u16 v3.l, v1.h, 1
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    v_cvt_u16_f16_e32 v4, v3
; GFX9-NEXT:    s_movk_i32 s4, 0xff
...
; GFX9-NEXT:    v_or_b32_e32 v6, v4, v3
; GFX9-NEXT:    v_cvt_u16_f16_e32 v3, v2
...
; GFX9-NEXT:    v_or_b32_e32 v8, v3, v2
...
; GFX9-NEXT:    v_min_u16_sdwa v7, v0, s4 dst_sel:BYTE_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX9-NEXT:    v_lshrrev_b32_e32 v5, 8, v4
; GFX9-NEXT:    v_or_b32_e32 v0, v1, v7
...
; GFX11-FAKE16-NEXT:    v_cvt_u16_f16_e32 v4, v3
...
; GFX12-FAKE16-NEXT:    v_cvt_u16_f16_e32 v4, v3
...
; GFX11-TRUE16-NEXT:    v_cvt_u16_f16_e32 v0.l, v0.l
; GFX11-TRUE16-NEXT:    v_cvt_u16_f16_e32 v3.h, v4.l
; GFX11-TRUE16-NEXT:    v_cvt_u16_f16_e32 v2.h, v5.l
; GFX11-TRUE16-NEXT:    v_cvt_u16_f16_e32 v1.h, v6.l
; GFX11-TRUE16-NEXT:    v_cvt_u16_f16_e32 v0.h, v7.l
; GFX11-TRUE16-NEXT:    v_cvt_u16_f16_e32 v1.l, v1.l
...
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v0.l, v0.l
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v3.h, v4.l
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v2.h, v5.l
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v1.h, v6.l
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v0.h, v7.l
; GFX12-TRUE16-NEXT:    v_cvt_u16_f16_e32 v1.l, v1.l
...
; GFX11-TRUE16-NEXT:    v_cvt_u32_f32_e32 v0, v4
; GFX11-TRUE16-NEXT:    v_cvt_u32_f32_e32 v4, v5
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v2, 16, v2
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v5, 16, v3
; GFX11-TRUE16-NEXT:    v_cvt_u32_f32_e32 v8, v6
; GFX11-TRUE16-NEXT:    v_cvt_f32_f16_e32 v3, v3.l
; GFX11-TRUE16-NEXT:    v_cvt_f32_f16_e32 v6, v7.l
; GFX11-TRUE16-NEXT:    v_cvt_f32_f16_e32 v1, v1.l
; GFX11-TRUE16-NEXT:    v_cvt_f32_f16_e32 v7, v2.l
; GFX11-TRUE16-NEXT:    v_cvt_f32_f16_e32 v5, v5.l
; GFX11-TRUE16-NEXT:    v_cvt_u32_f32_e32 v12, v3
; GFX11-TRUE16-NEXT:    v_cvt_u32_f32_e32 v2, v6
; GFX11-TRUE16-NEXT:    v_cvt_u32_f32_e32 v6, v1
; GFX11-TRUE16-NEXT:    v_cvt_u32_f32_e32 v10, v7
; GFX11-TRUE16-NEXT:    v_cvt_u32_f32_e32 v14, v5
; GFX11-TRUE16-NEXT:    v_mov_b32_e32 v1, 0
; GFX11-TRUE16-NEXT:    v_mov_b32_e32 v3, 0
; GFX11-TRUE16-NEXT:    v_mov_b32_e32 v5, 0
; GFX11-TRUE16-NEXT:    v_mov_b32_e32 v7, 0
...
; GFX12-TRUE16-NEXT:    v_cvt_u32_f32_e32 v0, v4
; GFX12-TRUE16-NEXT:    v_cvt_u32_f32_e32 v4, v5
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v2, 16, v2
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v5, 16, v3
; GFX12-TRUE16-NEXT:    v_cvt_u32_f32_e32 v8, v6
; GFX12-TRUE16-NEXT:    v_cvt_f32_f16_e32 v3, v3.l
; GFX12-TRUE16-NEXT:    v_cvt_f32_f16_e32 v6, v7.l
; GFX12-TRUE16-NEXT:    v_cvt_f32_f16_e32 v1, v1.l
; GFX12-TRUE16-NEXT:    v_cvt_f32_f16_e32 v7, v2.l
; GFX12-TRUE16-NEXT:    v_cvt_f32_f16_e32 v5, v5.l
; GFX12-TRUE16-NEXT:    v_cvt_u32_f32_e32 v12, v3
; GFX12-TRUE16-NEXT:    v_cvt_u32_f32_e32 v2, v6
; GFX12-TRUE16-NEXT:    v_cvt_u32_f32_e32 v6, v1
; GFX12-TRUE16-NEXT:    v_cvt_u32_f32_e32 v10, v7
; GFX12-TRUE16-NEXT:    v_cvt_u32_f32_e32 v14, v5
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v1, 0
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v3, 0
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v5, 0
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v7, 0
...
; GFX7-GI-NEXT:    s_min_u32 s5, s8, 1
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX7-GI-NEXT:    s_min_u32 s7, s7, 1
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v1, v1
...
; GFX7-GI-NEXT:    v_readfirstlane_b32 s8, v1
; GFX7-GI-NEXT:    v_cvt_f32_f16_e32 v1, s5
; GFX7-GI-NEXT:    s_min_u32 s5, s8, 0xff
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX7-GI-NEXT:    s_min_u32 s7, s7, 0xff
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v1, v1
; GFX7-GI-NEXT:    v_readfirstlane_b32 s8, v0
...
; GFX7-GI-NEXT:    v_readfirstlane_b32 s9, v1
; GFX7-GI-NEXT:    v_cvt_f32_f16_e32 v1, s4
; GFX7-GI-NEXT:    s_min_u32 s4, s9, 0xff
; GFX7-GI-NEXT:    v_readfirstlane_b32 s9, v0
; GFX7-GI-NEXT:    v_cvt_f32_f16_e32 v0, s19
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v1, v1
; GFX7-GI-NEXT:    v_cvt_f32_f16_e32 v2, s6
; GFX7-GI-NEXT:    s_min_u32 s6, s9, 0xff
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GFX7-GI-NEXT:    v_readfirstlane_b32 s9, v1
; GFX7-GI-NEXT:    v_cvt_u32_f32_e32 v1, v2
; GFX7-GI-NEXT:    s_min_u32 s8, s8, 0xff
; GFX7-GI-NEXT:    v_readfirstlane_b32 s10, v0
; GFX7-GI-NEXT:    s_min_u32 s9, s9, 0xff
; GFX7-GI-NEXT:    v_readfirstlane_b32 s11, v1
; GFX7-GI-NEXT:    s_min_u32 s10, s10, 0xff
; GFX7-GI-NEXT:    s_min_u32 s11, s11, 0xff
; GFX7-GI-NEXT:    v_mov_b32_e32 v0, s7
; GFX7-GI-NEXT:    v_mov_b32_e32 v1, s5
; GFX7-GI-NEXT:    v_mov_b32_e32 v2, s8
; GFX7-GI-NEXT:    v_mov_b32_e32 v3, s4
