...
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1100 -mattr=+real-true16 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX11,GFX11-TRUE16,GFX11PLUS,GFX11PLUS-TRUE16 %s
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1100 -mattr=-real-true16 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX11,GFX11-FAKE16,GFX11PLUS,GFX11PLUS-FAKE16 %s
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1200 -mattr=+real-true16 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX11PLUS,GFX11PLUS-TRUE16,GFX12,GFX12-TRUE16 %s
; RUN: llc -mtriple=amdgcn-amd-amdhsa -mcpu=gfx1200 -mattr=-real-true16 -verify-machineinstrs < %s | FileCheck -check-prefixes=GFX11PLUS,GFX11PLUS-FAKE16,GFX12,GFX12-FAKE16 %s
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4f16_u3u1:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx2 v[2:3], v[0:1], off
; GFX942-NEXT:    s_waitcnt vmcnt(0)
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4f16_3u6u:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dword v5, v[0:1], off offset:4
; GFX942-NEXT:    global_load_dword v4, v[2:3], off offset:4
; GFX942-NEXT:    s_waitcnt vmcnt(1)
; GFX942-NEXT:    v_alignbit_b32 v0, s0, v5, 16
; GFX942-NEXT:    s_waitcnt vmcnt(0)
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4f16_3uu7:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dword v5, v[0:1], off offset:4
; GFX942-NEXT:    global_load_dword v4, v[2:3], off offset:4
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4f16_35u5:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dword v5, v[0:1], off offset:4
...
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_perm_b32 v0, v4, v5, s0
; GFX942-NEXT:    v_mov_b32_e32 v1, v4
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4f16_2301:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx2 v[2:3], v[0:1], off
; GFX942-NEXT:    s_waitcnt vmcnt(0)
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4f16_6745:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4f16_2356:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx2 v[6:7], v[2:3], off
; GFX942-NEXT:    global_load_dword v4, v[0:1], off offset:4
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4f16_5623:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx2 v[6:7], v[2:3], off
; GFX942-NEXT:    global_load_dword v4, v[0:1], off offset:4
; GFX942-NEXT:    s_waitcnt vmcnt(1)
; GFX942-NEXT:    v_alignbit_b32 v0, v7, v6, 16
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_mov_b32_e32 v1, v4
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4f16_5734:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx2 v[4:5], v[2:3], off
; GFX942-NEXT:    global_load_dword v6, v[0:1], off offset:4
; GFX942-NEXT:    s_mov_b32 s0, 0x7060302
; GFX942-NEXT:    s_waitcnt vmcnt(1)
; GFX942-NEXT:    v_perm_b32 v0, v5, v4, s0
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_alignbit_b32 v1, v4, v6, 16
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4i16_2356:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx2 v[6:7], v[2:3], off
; GFX942-NEXT:    global_load_dword v4, v[0:1], off offset:4
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4f16_1100:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx2 v[2:3], v[0:1], off
; GFX942-NEXT:    s_mov_b32 s0, 0x7060302
...
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_perm_b32 v0, v2, v2, s0
; GFX942-NEXT:    v_perm_b32 v1, v2, v2, s1
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4f16_6161:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dword v4, v[0:1], off
; GFX942-NEXT:    global_load_dword v5, v[2:3], off offset:4
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4f16_2333:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dword v0, v[0:1], off offset:4
; GFX942-NEXT:    s_mov_b32 s0, 0x7060302
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_perm_b32 v1, v0, v0, s0
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4f16_6667:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dword v0, v[0:1], off offset:4
; GFX942-NEXT:    s_mov_b32 s0, 0x7060302
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v8f16_13_14_2_3:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx2 v[6:7], v[2:3], off offset:8
; GFX942-NEXT:    global_load_dword v4, v[0:1], off offset:4
; GFX942-NEXT:    s_waitcnt vmcnt(1)
; GFX942-NEXT:    v_alignbit_b32 v0, v7, v6, 16
; GFX942-NEXT:    s_waitcnt vmcnt(0)
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v3f16_0122:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx2 v[0:1], v[0:1], off
; GFX942-NEXT:    s_mov_b32 s0, 0x5040100
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_perm_b32 v1, v1, v1, s0
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GX900-NEXT:    s_endpgm
;
; GFX942-LABEL: fma_shuffle_v2f16:
; GFX942:       ; %bb.0: ; %entry
...
; GFX942-NEXT:    global_load_dwordx2 v[2:3], v6, s[2:3]
; GFX942-NEXT:    global_load_dwordx2 v[4:5], v6, s[6:7]
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_pk_fma_f16 v4, v0, v2, v4 op_sel_hi:[0,1,1]
; GFX942-NEXT:    v_pk_fma_f16 v2, v1, v2, v5 op_sel_hi:[0,1,1]
; GFX942-NEXT:    v_pk_fma_f16 v0, v0, v3, v4 op_sel:[1,0,0]
; GFX942-NEXT:    v_pk_fma_f16 v1, v1, v3, v2 op_sel:[1,0,0]
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: low16hi16bits_v2f16:
; GFX942:       ; %bb.0: ; %entry
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dword v4, v[0:1], off
; GFX942-NEXT:    global_load_dword v5, v[2:3], off
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: i16_low16hi16bits:
; GFX942:       ; %bb.0: ; %entry
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dword v4, v[0:1], off
; GFX942-NEXT:    global_load_dword v5, v[2:3], off
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4i8_concat:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_ushort v6, v[0:1], off
; GFX942-NEXT:    global_load_ushort v7, v[2:3], off
; GFX942-NEXT:    s_mov_b32 s0, 0x5040100
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_perm_b32 v0, v7, v6, s0
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4bf16_u3u1:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx2 v[2:3], v[0:1], off
; GFX942-NEXT:    s_waitcnt vmcnt(0)
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4bf16_3u6u:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dword v5, v[0:1], off offset:4
; GFX942-NEXT:    global_load_dword v4, v[2:3], off offset:4
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4bf16_3uu7:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dword v5, v[0:1], off offset:4
; GFX942-NEXT:    global_load_dword v4, v[2:3], off offset:4
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4bf16_35u5:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dword v5, v[0:1], off offset:4
; GFX942-NEXT:    global_load_dword v4, v[2:3], off
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4bf16_2301:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx2 v[2:3], v[0:1], off
; GFX942-NEXT:    s_waitcnt vmcnt(0)
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4bf16_6745:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx2 v[2:3], v[2:3], off
; GFX942-NEXT:    s_waitcnt vmcnt(0)
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4bf16_2356:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx2 v[6:7], v[2:3], off
; GFX942-NEXT:    global_load_dword v4, v[0:1], off offset:4
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4bf16_5623:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx2 v[6:7], v[2:3], off
; GFX942-NEXT:    global_load_dword v4, v[0:1], off offset:4
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4bf16_5734:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx2 v[4:5], v[2:3], off
; GFX942-NEXT:    global_load_dword v6, v[0:1], off offset:4
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4bf16_1100:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx2 v[2:3], v[0:1], off
; GFX942-NEXT:    s_mov_b32 s0, 0x7060302
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4bf16_6161:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dword v4, v[0:1], off
; GFX942-NEXT:    global_load_dword v5, v[2:3], off offset:4
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4bf16_2333:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dword v0, v[0:1], off offset:4
; GFX942-NEXT:    s_mov_b32 s0, 0x7060302
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v4bf16_6667:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dword v0, v[0:1], off offset:4
; GFX942-NEXT:    s_mov_b32 s0, 0x7060302
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v8bf16_13_14_2_3:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx2 v[6:7], v[2:3], off offset:8
; GFX942-NEXT:    global_load_dword v4, v[0:1], off offset:4
...
; GX900-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-LABEL: shuffle_v3bf16_0122:
; GFX942:       ; %bb.0:
; GFX942-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-NEXT:    global_load_dwordx2 v[0:1], v[0:1], off
; GFX942-NEXT:    s_mov_b32 s0, 0x5040100
