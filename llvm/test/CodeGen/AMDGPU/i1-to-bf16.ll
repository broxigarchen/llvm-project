...
; GFX11-TRUE16-NEXT:    v_add3_u32 v5, v6, v0, 0x7fff
...
; GFX12-TRUE16-NEXT:    v_add3_u32 v5, v6, v0, 0x7fff
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_va_vcc(0)
...
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, 16, v2
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-TRUE16-NEXT:    v_cndmask_b32_e32 v3, v5, v3, vcc_lo
; GFX12-TRUE16-NEXT:    v_mov_b16_e32 v0.h, v1.l
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2)
...
; GFX11-TRUE16-NEXT:    v_and_b16 v1.h, 1, v2.l
...
; GFX11-TRUE16-NEXT:    v_cmp_eq_u16_e32 vcc_lo, 1, v0.h
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e64 v2, 0, 1.0, vcc_lo
; GFX11-TRUE16-NEXT:    v_cmp_eq_u16_e32 vcc_lo, 1, v1.h
; GFX11-TRUE16-NEXT:    v_bfe_u32 v4, v2, 16, 1
...
; GFX12-TRUE16-NEXT:    v_and_b16 v1.h, 1, v2.l
...
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-TRUE16-NEXT:    v_cndmask_b32_e64 v2, 0, 1.0, vcc_lo
; GFX12-TRUE16-NEXT:    v_cmp_eq_u16_e32 vcc_lo, 1, v1.h
; GFX12-TRUE16-NEXT:    v_bfe_u32 v4, v2, 16, 1
; GFX12-TRUE16-NEXT:    s_wait_alu depctr_va_vcc(0)
