...
; GFX11-TRUE16-NEXT:    s_mov_b32 s16, s10
; GFX11-TRUE16-NEXT:    s_mov_b32 s17, s11
; GFX11-TRUE16-NEXT:    buffer_load_b32 v1, off, s[4:7], 0
; GFX11-TRUE16-NEXT:    buffer_load_b32 v2, off, s[20:23], 0
; GFX11-TRUE16-NEXT:    buffer_load_b32 v3, off, s[16:19], 0
; GFX11-TRUE16-NEXT:    s_mov_b32 s24, s14
; GFX11-TRUE16-NEXT:    s_mov_b32 s25, s15
; GFX11-TRUE16-NEXT:    s_mov_b32 s1, s9
; GFX11-TRUE16-NEXT:    buffer_load_b32 v4, off, s[24:27], 0
...
; GFX11-TRUE16-NEXT:    v_cmp_lt_f16_e32 vcc_lo, v2.l, v1.l
...
; GFX11-TRUE16-NEXT:    v_cndmask_b16 v1.l, v1.l, v2.l, s0
...
; GFX11-TRUE16-NEXT:    buffer_load_b32 v3, off, s[16:19], 0
; GFX11-TRUE16-NEXT:    buffer_load_b32 v4, off, s[20:23], 0
