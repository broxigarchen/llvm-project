...
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1200 -mattr=+real-true16 -denormal-fp-math=preserve-sign -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global -verify-machineinstrs < %s | FileCheck --check-prefixes=GFX11-FLUSH,GFX11-FLUSH-TRUE16 %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1200 -mattr=-real-true16 -denormal-fp-math=preserve-sign -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global -verify-machineinstrs < %s | FileCheck --check-prefixes=GFX11-FLUSH,GFX11-FLUSH-FAKE16 %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1200 -mattr=+real-true16 -denormal-fp-math=ieee -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global -verify-machineinstrs < %s | FileCheck --check-prefixes=GFX11-DENORM,GFX11-DENORM-TRUE16 %s
; RUN: llc -amdgpu-scalarize-global-loads=false -mtriple=amdgcn -mcpu=gfx1200 -mattr=-real-true16 -denormal-fp-math=ieee -denormal-fp-math-f32=preserve-sign -mattr=-flat-for-global -verify-machineinstrs < %s | FileCheck --check-prefixes=GFX11-DENORM,GFX11-DENORM-FAKE16 %s
...
; GFX10-FLUSH-NEXT:    s_mov_b32 s13, s15
; GFX10-FLUSH-NEXT:    s_mov_b32 s14, s2
; GFX10-FLUSH-NEXT:    s_mov_b32 s15, s3
; GFX10-FLUSH-NEXT:    s_mov_b32 s0, s8
; GFX10-FLUSH-NEXT:    buffer_load_ushort v2, off, s[12:15], 0
; GFX10-FLUSH-NEXT:    s_mov_b32 s1, s9
...
; GFX10-DENORM-NEXT:    s_mov_b32 s6, s2
; GFX10-DENORM-NEXT:    s_mov_b32 s7, s3
...
; GFX10-DENORM-NEXT:    s_mov_b32 s4, s10
; GFX10-DENORM-NEXT:    s_mov_b32 s5, s11
; GFX10-DENORM-NEXT:    s_mov_b32 s16, s12
...
; GFX10-DENORM-NEXT:    s_mov_b32 s0, s8
; GFX10-DENORM-NEXT:    s_mov_b32 s1, s9
...
; VI-FLUSH-NEXT:    s_load_dwordx2 s[8:9], s[4:5], 0x34
; VI-FLUSH-NEXT:    s_mov_b32 s7, 0xf000
; VI-FLUSH-NEXT:    s_mov_b32 s6, -1
; VI-FLUSH-NEXT:    s_mov_b32 s14, s6
; VI-FLUSH-NEXT:    s_waitcnt lgkmcnt(0)
; VI-FLUSH-NEXT:    s_mov_b32 s12, s2
; VI-FLUSH-NEXT:    s_mov_b32 s13, s3
; VI-FLUSH-NEXT:    s_mov_b32 s15, s7
...
; VI-FLUSH-NEXT:    buffer_store_short v0, off, s[4:7], 0
; VI-FLUSH-NEXT:    s_endpgm
;
; VI-DENORM-LABEL: fmuladd_f16_imm_a:
; VI-DENORM:       ; %bb.0:
; VI-DENORM-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; VI-DENORM-NEXT:    s_load_dwordx2 s[8:9], s[4:5], 0x34
; VI-DENORM-NEXT:    s_mov_b32 s7, 0xf000
; VI-DENORM-NEXT:    s_mov_b32 s6, -1
; VI-DENORM-NEXT:    s_mov_b32 s14, s6
; VI-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
; VI-DENORM-NEXT:    s_mov_b32 s12, s2
; VI-DENORM-NEXT:    s_mov_b32 s13, s3
; VI-DENORM-NEXT:    s_mov_b32 s15, s7
; VI-DENORM-NEXT:    s_mov_b32 s10, s6
; VI-DENORM-NEXT:    s_mov_b32 s11, s7
; VI-DENORM-NEXT:    buffer_load_ushort v0, off, s[12:15], 0 glc
; VI-DENORM-NEXT:    s_waitcnt vmcnt(0)
; VI-DENORM-NEXT:    buffer_load_ushort v1, off, s[8:11], 0 glc
; VI-DENORM-NEXT:    s_waitcnt vmcnt(0)
; VI-DENORM-NEXT:    s_mov_b32 s4, s0
; VI-DENORM-NEXT:    s_movk_i32 s0, 0x4200
; VI-DENORM-NEXT:    s_mov_b32 s5, s1
; VI-DENORM-NEXT:    v_fma_f16 v0, v0, s0, v1
; VI-DENORM-NEXT:    buffer_store_short v0, off, s[4:7], 0
; VI-DENORM-NEXT:    s_endpgm
;
...
; GFX10-FLUSH-NEXT:    s_load_dwordx2 s[8:9], s[4:5], 0x34
; GFX10-FLUSH-NEXT:    s_mov_b32 s6, -1
; GFX10-FLUSH-NEXT:    s_mov_b32 s7, 0x31016000
; GFX10-FLUSH-NEXT:    s_mov_b32 s14, s6
; GFX10-FLUSH-NEXT:    s_mov_b32 s15, s7
; GFX10-FLUSH-NEXT:    s_mov_b32 s10, s6
; GFX10-FLUSH-NEXT:    s_mov_b32 s11, s7
; GFX10-FLUSH-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-FLUSH-NEXT:    s_mov_b32 s12, s2
; GFX10-FLUSH-NEXT:    s_mov_b32 s13, s3
; GFX10-FLUSH-NEXT:    s_mov_b32 s4, s0
; GFX10-FLUSH-NEXT:    buffer_load_ushort v0, off, s[12:15], 0 glc dlc
; GFX10-FLUSH-NEXT:    s_waitcnt vmcnt(0)
; GFX10-FLUSH-NEXT:    buffer_load_ushort v1, off, s[8:11], 0 glc dlc
; GFX10-FLUSH-NEXT:    s_waitcnt vmcnt(0)
; GFX10-FLUSH-NEXT:    s_mov_b32 s5, s1
; GFX10-FLUSH-NEXT:    v_mul_f16_e32 v0, 0x4200, v0
; GFX10-FLUSH-NEXT:    v_add_f16_e32 v0, v0, v1
; GFX10-FLUSH-NEXT:    buffer_store_short v0, off, s[4:7], 0
; GFX10-FLUSH-NEXT:    s_endpgm
;
...
; GFX10-DENORM-NEXT:    s_load_dwordx2 s[8:9], s[4:5], 0x34
; GFX10-DENORM-NEXT:    s_mov_b32 s6, -1
; GFX10-DENORM-NEXT:    s_mov_b32 s7, 0x31016000
; GFX10-DENORM-NEXT:    s_mov_b32 s14, s6
; GFX10-DENORM-NEXT:    s_mov_b32 s15, s7
; GFX10-DENORM-NEXT:    s_mov_b32 s10, s6
; GFX10-DENORM-NEXT:    s_mov_b32 s11, s7
; GFX10-DENORM-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-DENORM-NEXT:    s_waitcnt vmcnt(0)
; GFX10-DENORM-NEXT:    s_mov_b32 s4, s0
; GFX10-DENORM-NEXT:    s_mov_b32 s5, s1
...
; GFX10-FLUSH-NEXT:    s_mov_b32 s15, s3
; GFX10-FLUSH-NEXT:    s_mov_b32 s0, s8
; GFX10-FLUSH-NEXT:    buffer_load_dword v2, off, s[12:15], 0
; GFX10-FLUSH-NEXT:    s_mov_b32 s1, s9
; GFX10-FLUSH-NEXT:    s_waitcnt vmcnt(1)
